...
*The original design sketch — the shape still holds. The backend is labelled "Playlist Maker" from
when playlist creation was the goal; that's Phase 2 (see [Roadmap](#roadmap-phase-2)), not what
ships today.*
